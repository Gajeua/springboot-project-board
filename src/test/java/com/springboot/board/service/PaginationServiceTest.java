...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = Void.class)   // 스프링부트 테스트의 옵션인 webEnvironment를 사용하여 스프링 부트의 테스트 무게를 줄인다.
class PaginationServiceTest {
    ...
    @ParameterizedTest(name = "[{index}] 현재 페이지: {0}, 총 페이지: {1} => {2}")   // 동일한 대상 메서드를 여러번 테스트하면서 입, 출력 값을 볼 수 있다.
